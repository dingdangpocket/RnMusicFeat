  ...
  const musicList = [
    {
      ...
      lyrics: [
        {time: '00', text: 'Jordann-Dehors'},
        {time: '14', text: 'La fanfare frémit au carrefour de ta forme'},
        {time: '25', text: 'Martellant sa poésie diforme'},
        {
          time: '35',
          text: 'Cest leau de vie dans la sève la conscience qui sachève',
        },
        {time: '46', text: 'Témoin de ta vision auditeur de ta prison'},
      ],
    },
    {
      id: '1',
    ...
    },
    {
      ...
      lyrics: [
        {time: '00', text: 'Jordann-Dehors'},
        {time: '09', text: '中文说唱除了我之外'},
        {time: '10', text: '都要被区别对待'},
        {time: '12', text: 'My punchline 像本嘻哈圣经被人跪拜'},
        {time: '15', text: '我和我的家族兄弟拳头一致对外'},
        {time: '17', text: '我们的最爱是sipping Henny'},
        {time: '19', text: '干掉假的rappers当做配菜'},
        {time: '22', text: '你们要记得'},
        {time: '23', text: '招惹我们跳火坑是不会有存活率的'},
        {time: '26', text: '你吞了麦克风也无法像我一样押韵'},
      ],
    },
    {
      id: '3',
    ...
    },
    {
      ...
      trackUrl:
        'https://webfs.hw.kugou.com/202407111744/1b73277dce0a02cd9abae788da4f2327/v2/deb87610f05cc93eaf4c1d95c9337cd4/G369/M0A/8C/13/UZUEAGU82bmANsGGADG6m0DNm0w345.mp3',
      lyrics: [
        {time: '00', text: 'bôa - DUVET'},
        {time: '01', text: 'And you dont seem to understand'},
        {time: '06', text: 'A shame you seemed an honest man'},
        {time: '11', text: 'And all the fears you hold so dear'},
        {time: '16', text: 'Will turn to whisper in your ear'},
        {time: '21', text: 'And you know what they say might hurt you'},
      ],
    },
    {
      id: '5',
